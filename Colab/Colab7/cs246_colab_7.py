...
Original file is located at
    https://colab.research.google.com/drive/1gFJlfrf6MYAlS6sAOFMfrK249mADIvT1
...
training = spark.read.format("libsvm").option("numFeatures", "780").load("mnist-digits-train.txt")
...
# YOUR CODE HERE
print("Training size is ({}, {})".format(training.count(), len(training.columns)))
print("Testing size is ({}, {})".format(test.count(), len(test.columns)))
